...
import (
	...
	"github.com/eacsuite/neutrino/blockntfns"
...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*eacutil.Block, error)
...
func WatchAddrs(watchAddrs ...eacutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *headerfs.BlockStamp) ([]*eacutil.Tx, error) {
	...
	relevantTxs := make([]*eacutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *eacutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *eacutil.Tx) (bool, error) {
...
func AddAddrs(addrs ...eacutil.Address) UpdateOption {
