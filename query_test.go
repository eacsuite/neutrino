...
import (
	...
	"github.com/eacsuite/neutrino/cache"
...
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) (
	...
	blocks := make([]*eacutil.Block, 0, 256)
	genesis := eacutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
	...
	for height := 1; ; height++ {
		...
		block, err := eacutil.NewBlockFromBytes(blockBytes)
		if err != nil {
