...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*eacutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, eacutil.NewBlock(&Block100000))
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, eacutil.NewBlock(&Block99999))
...
// The following is taken from the eacsuite/eacutil project.
