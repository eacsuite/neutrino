...
import (
	...
	"github.com/eacsuite/eacd/blockchain"
	...
	"github.com/eacsuite/neutrino/chainsync"
	"github.com/eacsuite/neutrino/headerfs"
	"github.com/eacsuite/neutrino/headerlist"
	"github.com/eacsuite/neutrino/query"
)
...
type blockManagerCfg struct {
	...
	GetBlock func(chainhash.Hash, ...QueryOption) (*eacutil.Block, error)
...
func (b *blockManager) checkHeaderSanity(blockHeader *wire.BlockHeader,
	...
	stubBlock := eacutil.NewBlock(&wire.MsgBlock{
		Header: *blockHeader,
	})
...
func (b *blockManager) calcNextRequiredDifficulty(newBlockTime time.Time,
	...
	// earthcoin specific: range is 1 greater for all but the first retarget
	if firstBlockNum != 0 {
		firstBlockNum -= 1
	}
